---
title: "KV 스토리지로 데이터 저장하기"
description: "Cloudflare Workers KV는 간단하면서도 강력한 키-값 저장소입니다."
---
...
**더 배우기:**
- [Workers 기초](/workers-basics/) - Workers에서 KV 사용
- [실전 프로젝트](/project-company-intro/) - KV 적용해보기
