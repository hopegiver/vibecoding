---
title: "Workers로 백엔드 만들기"
description: "Cloudflare Workers와 Hono 프레임워크로 강력한 백엔드 API를 만들어봅시다."
---
...
- **[KV 스토리지](/kv-storage/)** - 키-값 저장소, 간단한 데이터 저장
- **[D1 데이터베이스](/d1-database/)** - SQL 데이터베이스, 관계형 데이터
- **[R2 파일 스토리지](/r2-storage/)** - 파일 업로드 및 저장
