---
title: "Workers에서 사용자 인증 구현하기"
description: "API를 만들 때 가장 중요한 것 중 하나가 사용자 인증입니다. 누가 API를 사용하는지 확인하고, 권한에 따라 접근을 제어해야 합니다. JWT(JSON Web Token)를 사용하면 쉽게 구현할 수 있습니다!"
---
...
- **[OpenAPI 문서 만들기](/workers-openapi/)** - 인증 스펙 문서화
- **[D1 데이터베이스](/d1-database/)** - 사용자 데이터 관리
