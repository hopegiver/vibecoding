...
description: "완성된 웹사이트를 GitHub에 올려서 Cloudflare Pages로 배포할 준비를 합니다. 복잡한 명령어는 AI가 대신 실행해줍니다!"
---
...
GitHub에 코드를 올렸다면 이제 [Pages 소개](/pages-introduction/)로 넘어가서 Cloudflare Pages와 연결해봅시다!
