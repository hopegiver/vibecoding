---
title: "환경 변수와 Secrets 관리"
description: "API 키, 데이터베이스 연결 정보 같은 민감한 정보를 안전하게 관리하는 방법을 배워봅시다."
---
...
- **[로깅과 모니터링](/workers-logging/)** - 에러 추적하기
- **[실전: REST API 만들기](/workers-rest-api/)** - 완전한 API 구축
- **[사용자 인증 (JWT)](/workers-auth/)** - JWT_SECRET 활용
