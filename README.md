...
**초급자**: 1장 → 2장 → 3장 → 4장 → 6장 프로젝트 1-2개

**중급자**: 1-2장 훑어보기 → 5장 → 6장 전체 → 7장

**개발자**: 2장 → 4장 → 8장 → 필요한 프로젝트
...
### 5. 인터랙티브한 웹 만들기 (JavaScript 기초)
- [JavaScript가 뭔가요?](./docs/javascript-intro.md)
- [버튼 클릭 이벤트 만들기](./docs/javascript-events.md)
- [간단한 계산기 만들기](./docs/project-calculator.md)
- [할일 목록(To-Do List) 만들기](./docs/project-todo-list.md)

### 6. JSON 파일로 데이터 관리하기
- [JSON이 뭔가요?](./docs/json-basics.md)
- [JSON 파일 만들고 읽기](./docs/json-file-read.md)
- [데이터 목록 표시하기](./docs/json-display-data.md)
- [프로젝트: 직원 명부 만들기](./docs/project-employee-list.md)
- [프로젝트: 간단한 블로그](./docs/project-simple-blog.md)
...
- [Workers로 백엔드 만들기](./docs/workers-basics.md)
